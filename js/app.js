...
//For restarting game when start is pressed
function runInit() {
  dealersDialogue();
  playersDialogue();
  init();
  ...
  //Deal delay to make sure buttons come on
  setTimeout(function () {
    disableStartButton();
    disableSplitButton();
    disableDoubleButton();
...
//HELPER FUNCTIONS//////////////////////////////
//Run dealer when player ends turn//////////////////////////////
function runDealer() {
  flipSecretCard();
  updateDealerSumBox();
  ...
  // counts how many round is busted
  let count = 0;
...
//Shift focus//////////////////////////////
//Shift to next hand after current hand is done, if splitted
function shiftFocus() {
  handEnded = true;
  document
    .getElementById(`playersArray${focusedHand}`)
